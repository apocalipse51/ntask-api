define({ "api": [
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Sucesso",
          "content": "HTTP/1.1 200 OK\n{\"token\": \"asi1231lk2n3l1lk4l5m672309bdf\"}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "header": {
      ...
      "examples": [
        {
          "title": "Header",
          "content": "{\"Authorization\": \"JWT lakjsdlaksjd90812u3987asdhas\"}",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "tasks.done",
            "description": "<p>Status de conclusão da tarefa</p>"
          },
          {
            "group": "Success 200",
            "type": "Date",
  ...
  },
  {
    "type": "post",
    "url": "/tasks",
    "title": "Cadastra uma nova tarefa",
    "group": "Tarefas",
    "header": {
      "fields": {
        "Header": [
  ...
  },
  {
    ...
    "header": {
      ...
      "examples": [
        {
          "title": "Header",
          "content": "{\"Authorization\": \"JWT çalskda9s0ud12983095alskdma\"}",
          "type": "json"
        }
      ]
    },
