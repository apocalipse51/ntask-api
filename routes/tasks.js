module.exports = app => {
    ...
    app.route("/tasks")   
         ...
         * @apiSuccess {Boolean} tasks.done Status de conclusão da tarefa
         * @apiSuccess {Date} tasks.updated_at Data de atualização
         * @apiSuccess {Date} tasls.created_at Data de criação
        ...
        */    
        ...
        /**
         * @api {post} /tasks Cadastra uma nova tarefa
         * @apiGroup Tarefas
         * @apiHeader {String} Authorization Token de usuário
         * @apiHeaderExample {json} Header
         *      {"Authorization": "JWT lakjsdlaksjd90812u3987asdhas"}
         ...
         * @apiSuccess {Boolean} done Status de conclusão da tarefa
    ...
    app.route("/tasks/:id")
         ...
         * @apiParam {id} id Id da tarefa
         * @apiParam {String} title Título da tarefa
         * @apiParam {Boolean} done Status de conclusão da tarefa
         * @apiParamExample {json} Entrada
         *      {
         *          "title": "Trabalhar",
         *          "done": true
